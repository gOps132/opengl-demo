...
// TODO: display class which handles the OpenGL context and the window and its destructor will call glfwterminate automatically.
...
void processInput(GLFWwindow *window)
{
 ...
 int main(void)
 {
    ...
    //     already bound but multiple VertexBuffers needs to be undbound
